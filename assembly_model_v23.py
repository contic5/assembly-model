...
#Extra features
calculateusingmax=False #If false, will calculate using average of max, min and average for each attribute.
    ...
    for j in range(len(parts)):
        ...
        for k in range(len(prioritynames)):
            ...
            #Calculate using average for each priority
                ...
                averageattributevalues[k]=averageattributevalues[k]//len(parts)
                averageattributevalues[k]=(minimumattributevalues[k]+averageattributevalues[k]+maximumattributevalues[k])/3
...
def main():
    ...
    if(usingfiles):
        ...
        robotlimits=copy.deepcopy(robotmin)
